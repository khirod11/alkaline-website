...
//         <h3>
//           Balance Your Body. Elevate Your Energy.<br />
//           One Sip At A Time.
//         </h3>
//         <p>
//           Unlike ordinary bottled water, alkaline water has a higher pH level (typically 8.5 to 9.5)
//           that helps neutralize acidity in the body, improve hydration, and support overall wellness.
//           It's not just about quenching thirst — it's about restoring balance from within.
//         </p>
//         <p>
//           Founded with a passion for wellness and purity, our team ensures every drop you drink is
//           triple-filtered, mineral-balanced, and delivered fresh to your doorstep. We serve
//           households, offices, gyms, and cafes — offering flexible delivery schedules and
//           eco-friendly bottle exchange programs to reduce plastic waste.
//         </p>
//       </div>
